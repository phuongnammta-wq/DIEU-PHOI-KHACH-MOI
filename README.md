# Tra cứu ghế khách mời ANH HÙNG 2026

Web app tĩnh để tra cứu nhanh ghế ngồi khách mời trên điện thoại từ file CSV `DANH_SACH_KHACH_MOI_TRA_CUU_GHE_ANH_HUNG_2026.csv`.
...
- `DANH_SACH_KHACH_MOI_TRA_CUU_GHE_ANH_HUNG_2026.csv`: file nguồn dữ liệu
...
## Dữ liệu hiện tại
- Tổng số bản ghi: 216
- File nguồn: `DANH_SACH_KHACH_MOI_TRA_CUU_GHE_ANH_HUNG_2026.csv`
